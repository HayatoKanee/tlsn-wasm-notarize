...
/// Output from the notarize step: hex-encoded bincode of attestation and secrets.
#[derive(Debug, Tsify, Serialize)]
#[tsify(into_wasm_abi)]
pub struct NotarizeOutput {
    /// Hex-encoded bincode serialization of the Attestation.
    pub attestation: String,
    /// Hex-encoded bincode serialization of the Secrets.
    pub secrets: String,
}

/// Configuration for building a Presentation with selective disclosure.
#[derive(Debug, Tsify, Deserialize)]
#[tsify(from_wasm_abi)]
pub struct PresentationConfig {
    /// Hex-encoded bincode of the Attestation.
    pub attestation_hex: String,
    /// Hex-encoded bincode of the Secrets.
    pub secrets_hex: String,
    /// Byte ranges to reveal.
    pub reveal: RevealConfig,
}

/// Which byte ranges of sent/recv transcript to reveal.
#[derive(Debug, Tsify, Deserialize)]
#[tsify(from_wasm_abi)]
